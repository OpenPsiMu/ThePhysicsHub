...
function setup() {
  ...
  outerCanvas.parrent('simwrapper');
  ...
  velocitySlider = makeSlider(i1r2);
  ...
  btnReset.onclick = () => {
    ...
    constants.g = constants.defaultG;
    constants.ρ = constants.defaultρ;
    ...
    projectile.trajectoryCount = 0
    resetSliders();
    console.log(projectile.trajectorydt > params.trajectoryPeriod)
  }

  gSlider = makeSlider(i3r1);
  ...
  gSlider.slider.oninput = () => {
    gSlider.setValueLabel(gSlider.slider.value + 'x')
    constants.g = gSlider.slider.value * constants.defaultG;
    i3r2.setLabel('Gravitational acceleration: ' + constants.g.toFixed(2) + ' m/s²');
  }

  airSlider = makeSlider(i3r3);
